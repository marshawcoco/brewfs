...
**Goal:** Improve BrewFS Redis + S3 large read/write performance and verify every effective change with `brewfs/docker/compose-xfstests/run_redis_perf.sh`.
...
- Verified command: `bash /mnt/slayerfs/brewfs/brewfs/docker/compose-xfstests/run_juicefs_perf.sh --tools "fio-bigwrite fio-bigread fio-seqread fio-seqwrite fio-randread fio-randwrite fio-randrw dirperf metaperf"`
...
- Read/modify: `/mnt/slayerfs/brewfs/brewfs/src/chunk/store.rs` for block read/range read/cache strategy.
- Read/modify: `/mnt/slayerfs/brewfs/brewfs/src/vfs/io/reader.rs` for read session, prefetch submission, and prefetch pressure behavior.
- Read/modify: `/mnt/slayerfs/brewfs/brewfs/src/vfs/io/writer.rs` for upload/commit scheduling and writeback behavior.
- Read/modify: `/mnt/slayerfs/brewfs/brewfs/src/vfs/cache/write_back.rs` for dirty slice persistence overhead.
- Read/modify: `/mnt/slayerfs/brewfs/brewfs/docker/compose-xfstests/run_redis_perf.sh` only if perf runner propagation blocks measurement.
- Read-only comparison: `/mnt/slayerfs/brewfs/brewfs/juicefs/pkg/chunk/cached_store.go`, `/mnt/slayerfs/brewfs/brewfs/juicefs/pkg/vfs/reader.go`, `/mnt/slayerfs/brewfs/brewfs/juicefs/pkg/vfs/writer.go`.
...
python3 - <<'PY'
import json, pathlib
root = max(pathlib.Path("/mnt/slayerfs/brewfs/brewfs/docker/compose-xfstests/artifacts").glob("perf-run-*"), key=lambda p: p.stat().st_mtime)
...
Read `/mnt/slayerfs/brewfs/brewfs/src/vfs/io/reader.rs:136` and `/mnt/slayerfs/brewfs/brewfs/src/vfs/fs/mod.rs:278`.
...
```bash
git add /mnt/slayerfs/brewfs/brewfs/src/vfs/io/reader.rs
...
Read `/mnt/slayerfs/brewfs/brewfs/src/vfs/cache/write_back.rs:97`.
...
```bash
git add /mnt/slayerfs/brewfs/brewfs/src/vfs/cache/write_back.rs
...
Read `/mnt/slayerfs/brewfs/brewfs/juicefs/pkg/chunk/cached_store.go:97` and `/mnt/slayerfs/brewfs/brewfs/src/chunk/store.rs:638`.
...
```bash
git add /mnt/slayerfs/brewfs/brewfs/src/chunk/store.rs
