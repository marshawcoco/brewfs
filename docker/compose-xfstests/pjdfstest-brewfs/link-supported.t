...
desc="brewfs: link covers supported regular-file hardlink semantics"
...
expect regular,1 lstat ${n0} type,nlink

expect 0 link ${n0} ${n1}
expect regular,2 lstat ${n0} type,nlink
expect regular,2 lstat ${n1} type,nlink

expect 0 link ${n1} ${n2}
expect regular,3 lstat ${n0} type,nlink
expect regular,3 lstat ${n1} type,nlink
expect regular,3 lstat ${n2} type,nlink
