...
Several BrewFS cargo tests depend on storage services (PostgreSQL, etcd, Redis). This document describes how to quickly set up these services using Docker Compose or Podman Compose.
...
- **PostgreSQL**: username `brewfs`, password `brewfs`
