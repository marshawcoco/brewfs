# BrewFS Permission Model

## Overview

BrewFS persists POSIX-style permission bits and ownership (uid/gid) in file
...
When files or directories are created through the FUSE layer, BrewFS strips
...
```text
chmod 4755 /mnt/brewfs/file.txt
...
```text
chown 1000:1000 /mnt/brewfs/file.txt
