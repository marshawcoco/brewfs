...
rust_binary(
    ...
    deps = [
        ...
        "//third-party/rust/crates/aws-config/1.8.14:aws-config",
        "//third-party/rust/crates/aws-sdk-s3/1.119.0:aws-sdk-s3",
        "//third-party/rust/crates/base64/0.22.1:base64",
        "//third-party/rust/crates/bitflags/2.11.0:bitflags",
        "//third-party/rust/crates/bytes/1.11.1:bytes",
        "//third-party/rust/crates/chrono/0.4.43:chrono",
        "//third-party/rust/crates/clap/4.5.58:clap",
        ...
        "//third-party/rust/crates/env_logger/0.11.9:env_logger",
        ...
        "//third-party/rust/crates/hostname/0.3.1:hostname",
        "//third-party/rust/crates/hyper/0.14.32:hyper",
        "//third-party/rust/crates/if-addrs/0.6.7:if-addrs",
        "//third-party/rust/crates/libc/0.2.182:libc",
        "//third-party/rust/crates/log/0.4.29:log",
        "//third-party/rust/crates/md5/0.7.0:md5",
        "//third-party/rust/crates/moka/0.12.13:moka",
        "//third-party/rust/crates/parking_lot/0.12.5:parking_lot",
        "//third-party/rust/crates/rand/0.9.2:rand",
        "//third-party/rust/crates/redis/0.26.1:redis",
