//! BrewFS configuration management
//!
...
pub enum DatabaseType {
    ...
    TiKv {
        ...
        /// Logical key prefix for isolating BrewFS metadata inside a TiKV cluster.
...
fn default_sqlite_url() -> String {
    "sqlite:///tmp/brewfs/metadata.db".to_string()
}
...
impl Config {
    ...
    pub fn from_path(backend_path: &Path) -> Result<Self, ConfigError> {
        let config_file = backend_path.join("brewfs.yml");
