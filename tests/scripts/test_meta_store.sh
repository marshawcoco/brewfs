...
# 设置变量
NETWORK_NAME="brewfs-network"
ETCD_IMAGE="quay.io/coreos/etcd:v3.6.0"
REDIS_IMAGE="redis:7.2-alpine"
POSTGRES_IMAGE="postgres:15-alpine"

ETCD_CONTAINER="etcd-brewfs-test"
REDIS_CONTAINER="redis-brewfs-test"
POSTGRES_CONTAINER="pgsql-brewfs-test"
...
check_container_health() {
    ...
    case $check_type in
        ...
        "redis")
            ...
            ;;
        "postgres")
            docker exec "$container_name" pg_isready -U brewfs > /dev/null 2>&1
            ;;
        *)
            return 1
            ;;
...
start_containers() {
    ...
    docker run -d \
        ...
        -e POSTGRES_USER=brewfs \
        -e POSTGRES_PASSWORD=brewfs \
...
echo "PostgreSQL    | $POSTGRES_CONTAINER | postgresql://brewfs:brewfs@localhost:5432/database"
echo "=========================================="
echo ""
